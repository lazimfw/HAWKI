...
function showHelp() {
    ...
    echo "  check                           - Check required dependencies" . YELLOW . " [DEPRECATED]" . RESET . PHP_EOL;
    ...
    echo "  setup-models                    - Configure AI model providers" . YELLOW . " [DEPRECATED]" . RESET . PHP_EOL;
    ...
    echo "      -build                      - Build the project" . PHP_EOL;
    echo "  stop                            - Stop all running processes" . PHP_EOL;
    echo "  --version, -v                   - Check the current and available HAWKI versions" . PHP_EOL;
    ...
    echo BOLD . "https://docs.hawki.info//" . RESET . PHP_EOL . PHP_EOL;
