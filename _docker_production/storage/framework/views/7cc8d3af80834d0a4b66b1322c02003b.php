        ...
        <div class="modal-content-wrapper">
            ...
            <div class="modal-content">
                ...
                <div class="row modal-buttons-bar top-gap-3" id="confirm-btn-bar">
                    <button class="btn-lg-stroke" id="modal-cancel-button"><?php echo e($translation["Cancel"]); ?></button>
                    <button class="btn-lg-fill red-text" id="modal-confirm-button"><?php echo e($translation["Confirm"]); ?></button>
                </div>
                <div class="row  top-gap-3" id="info-btn-bar">
                    <button class="btn-lg-stroke red-text" id="modal-close-button" style="justify-self: end"><?php echo e($translation["Close"]); ?></button>
                </div>
...
<?php /**PATH /var/www/html/resources/views/partials/home/modals/confirm-modal.blade.php ENDPATH**/ ?>